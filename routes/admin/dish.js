...
/*
*POST /admin/dish
请求参数；{title：'xxx',imgUrl:"...jpg",price:"xxx",detail:"xxx",categoryId:"xx"}
*添加一个新的菜品
输出消息：
...
/*
*PUT /admin/dish
请求参数；{did：'xxx',title:"...jpg",imgUrl:"xxx",price:"xxx",categoryId:"xx"}
*添加一个新的菜品
输出消息：
{code:"200",msg:"dish uptated succ"}
{code:"400",msg:"dish uptated filed"}
*/